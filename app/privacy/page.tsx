...
const PrivacyPage = () => {
  return (
    <div className="max-w-4xl mx-auto my-10 p-5 bg-white shadow-lg rounded-lg">
        ...
        <h3> The information we collect from you may be used in the following ways:</h3>
        <p className="mb-4 list-disc list-inside">
        Usage Data: We do not collect or store any information about your interactions with our site. This includes, but is not limited to, IP addresses, browser type, Internet Service Provider (ISP), referring/exit pages, and operating system.
        Cookies: We do not use cookies of our own to collect or store personal information about our visitors. The only cookies that may be used are those strictly necessary for the technical operation of the website, and are not used to personally track users.
        </p>

        <h2 className="text-xl font-semibold mb-4">3. Use of Information</h2>
        <p className="mb-4">
        Because we do not collect personal information, there is no use of such information to personalize experiences, improve our website, improve customer service, process transactions, or administer promotional activities.
        </p>

        <h2 className="text-xl font-semibold mb-4">4. Information Sharing and Disclosure</h2>
        <p className="mb-4">
        We do not share or disclose any personal information about our users, simply because we do not collect such information. There is no sale, trade or rental of personal information, as we do not possess such information.
        </p>
